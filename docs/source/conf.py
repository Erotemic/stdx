"""
Notes:
    Based on template code in: ~/code/stdx/docs/source/conf.py
    ...
    cd ~/code/stdx/docs
    sphinx-apidoc -f -o ~/code/stdx/docs/source ~/code/stdx/stdx --separate
    make html
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/stdx/advanced/
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/stdx/versions/
"""
#
...
# html_logo = '.static/stdx.svg'
# html_favicon = '.static/stdx.ico'
...
latex_documents = [
    (master_doc, 'stdx.tex', 'stdx Documentation',
     'Jon Crall', 'manual'),
]
...
man_pages = [
    (master_doc, 'stdx', 'stdx Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'stdx', 'stdx Documentation',
     author, 'stdx', 'One line description of project.',
     'Miscellaneous'),
]
